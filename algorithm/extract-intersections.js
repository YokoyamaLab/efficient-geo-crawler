...
const extractIntersections = (roadMaps, crawlingArea) => {
    const scoreTable = {
        'motorway': 10,
        'trunk': 9,
        'primary': 8,
    ...
    const sortedIntersections = intersections.sort((a, b) => b.score - a.score);
    return sortedIntersections;
};

module.exports = extractIntersections;
